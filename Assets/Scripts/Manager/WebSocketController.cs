...
namespace WebSocketUnity
{
    ...
    {
        //mine Create this instance
        public static WebSocketController mInstance;
        //
        ...
        protected void HandleOpen(object sender, EventArgs e)
        {
           // if (logEventsInEditor && Debug.isDebugBuild)
           // {
                Debug.LogError($"Connected to {url}");
           // }
            
            isConnected = true;

            //mine---sign message to the server
            //{"event":"message"}
        ...
        protected void HandleClose(object sender, CloseEventArgs e)
        {
            //if (logEventsInEditor && Debug.isDebugBuild)
          //  {
                Debug.LogError($"Disconnected from {url}");
          //  }
        ...
        public void Send(string message)
        {
            if (isConnected && _webSocket.IsAlive)
            {
                ...
                Debug.LogError("Message Sending....:"+message);
            }
        }
